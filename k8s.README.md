...
2. Cambiar el valor (se puede usar un editor
   en [línea para convertir a base64](https://www.rapidtables.com/web/tools/base64-decode.html))
...
## Crear secreto para pull de imagenes de gcloud

```
kubectl create secret docker-registry gcr-json-key --docker-server=southamerica-east1-docker.pkg.dev --docker-username=_json_key --docker-password="$(cat 'C:\Users\Israel\Downloads\dark-mark-452418-d3-37c8da5a4091.json')" --docker-email=x1zr4x@gmail.com
```
